            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="mb-4 bg-white p-4 border">
                        <h5 class="fw-600 mb-3 fs-16 text-soft-dark pb-2 border-bottom">{{ translate('Order Summary') }}
                        </h5>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top-0 pr-0 py-2">{{ single_price($combined_order->grand_total) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <div class="col-xl-5 col-md-6 ml-auto mr-0">
                                            <table class="table ">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th class="border-top-0 py-2">{{ translate('Tax (18%)') }}</th>
                                                        <td class="text-right border-top-0 pr-0 py-2">
