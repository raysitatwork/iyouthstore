...
@section('content')
        ...
        <section class="mb-3 mb-md-4 pt-3 pt-md-2rem">
            <div class="container">
                ...
                <div class="bg-white px-sm-3">
                    <div class="aiz-carousel sm-gutters-17" data-items="8" data-xxl-items="8" data-xl-items="8" data-lg-items="6"
                        data-md-items="5" data-sm-items="3" data-xs-items="2" data-arrows="true" data-dots="false"
                        data-autoplay="false" data-infinite="true" data-center="false">
                ...
                @if (get_setting('home_slider_images', null, $lang) != null)
                    ...
                    <div class="aiz-carousel dots-inside-bottom mobile-img-auto-height" data-autoplay="true"
                        ...
                        @php
                            ...
                            $mobile_images = json_decode(get_setting('home_slider_images_mobile', null, $lang), true) ?? [];
                            $mobile_links = json_decode(get_setting('home_slider_links_mobile', null, $lang), true) ?? [];
                        @endphp

                        @foreach ($sliders as $key => $slider)
                            @php
                                $desktopLink = $home_slider_links[$key] ?? '';
                                $mobileLink = $mobile_links[$key] ?? $desktopLink;
                                $mobileImage = $mobile_images[$key] ?? null;
                            @endphp
                                ...
                                <a href="{{ $mobileLink }}">
                                    ...
                                    <div
                                        ...
                                        <picture>
                                            ...
                                            <!-- 📱 Mobile -->
                                            @if ($mobileImage)
                                                <source media="(max-width: 768px)" srcset="{{ uploaded_asset($mobileImage) }}">
                                            @endif

                                            <!-- 🖥️ Desktop -->
                                            <img class="img-fit h-100 w-100 m-auto has-transition"
                                                src="{{ $slider ? my_asset($slider->file_name) : static_asset('assets/img/placeholder.jpg') }}"
                                                alt="{{ env('APP_NAME') }} promo"
                                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
    ...
    @if ($flash_deal != null)
        <section class="mb-2 mb-md-3 mt-2 mt-md-3"
            ...
            id="flash_deal">
            <div class="container">
                <div class="@if (!$flash_deal_bg_full_width) px-3 px-md-2rem @endif pb-3 pb-md-4"
                    style="background: {{ $flash_deal_bg != null ? $flash_deal_bg : '#faf9f7' }};">
                    <!-- Top Section -->
                    <div
                        class="d-flex flex-wrap align-items-baseline justify-content-center justify-content-sm-between mb-2 mb-md-3 pt-2 pt-md-3 position-relative">
                        <!-- Title -->
                    ...
                    <div class="row no-gutters align-items-center border" style="background: {{ $flash_deal_bg }};">
                        ...
                        <div class="col-xxl-10 col-md-9 col-sm-8 col-7">
                            ...
                            @endphp
                            <div class="aiz-carousel arrow-inactive-none arrow-x-0" data-items="6" data-xxl-items="6"
                                data-xl-items="5" data-lg-items="3.7" data-md-items="3" data-sm-items="2.7"
                                data-xs-items="1.5" data-arrows="true" data-dots="false">
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
            <div>
                ...
                <button onclick="openstoreFormModal()" class="btn btn-outline-primary ml-2">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center p-4">
                ...
                <div class="modal-body">
                    If you want to start your own business and are interested in getting an iYouth Store franchise, please
                    download the files from the link below, study them, and then apply to open a franchise store.
        ...
        <div class="row gutters-16">
            ...
            @if ($homeBanner3Images != null)
                <div class="col-xl-4 mb-2 mb-md-3 mt-2 mt-md-3 d-none d-xl-block">
                    ...
                    @endphp
                    <div class="aiz-carousel overflow-hidden arrow-inactive-none arrow-dark arrow-x-0" data-items="1"
                        data-arrows="true" data-dots="false" data-autoplay="true">
                    ...
                    <div class="col py-3 py-lg-0">
                        <div class="h-100" id="section_top_brands">
                            <div class="border px-3 pt-3">
                                ...
                                <!-- Brands Section -->
                                <div class="aiz-carousel arrow-x-0 arrow-inactive-none py-4"
                                    data-rows="{{ $data_rows }}" data-items="{{ $xxl_items }}"
                                    data-xxl-items="{{ $xxl_items }}" data-xl-items="{{ $xl_items }}"
                                    data-lg-items="{{ $lg_items }}" data-md-items="{{ $md_items }}"
                                    data-sm-items="{{ $sm_items }}" data-xs-items="{{ $xs_items }}"
                                    data-arrows="true" data-dots="false">
                    ...
                    <div class="text-center text-xl-left position-relative z-5">
                        <div class="d-lg-flex justify-content-lg-between">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <g id="Group_24326" data-name="Group 24326" transform="translate(-274.202 -5254.612)"
                                        ...
                                        <g id="Mask_Group_23" data-name="Mask Group 23"
                                            transform="translate(304.445 5355.902) rotate(-45)"
                                            clip-path="url(#clip-path)">
                                            <g id="Group_24322" data-name="Group 24322"
                                                transform="translate(7.681 5.856)">
                            ...
                            <div class="">
                                ...
                                <div class="mt-5">
                                    <a href="{{ route('coupons.all') }}" class="btn btn-dark fs-16 px-5 rounded-4"
                        ...
                        <div class="d-sm-flex bg-white pb-3 pb-md-4">
                            ...
                            <div class="px-3 px-sm-4">
                                <div class="w-sm-270px h-320px mx-auto">
                                    <a href="{{ route('customer.products') }}"
                                        class="d-block h-100 w-100 w-xl-auto hov-scale-img overflow-hidden">
                                        <img src="{{ uploaded_asset($classifiedBannerImage) }}"
                                            alt="{{ translate('Classified Ads') }}" class="img-fit h-100 has-transition"
                                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="px-0 px-sm-4 w-100 overflow-hidden">
                                <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-items="5" data-xxl-items="5"
                                    data-xl-items="3.5" data-lg-items="3" data-md-items="2" data-sm-items="1"
