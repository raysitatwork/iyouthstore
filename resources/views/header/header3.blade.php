...
<style>
    ...
    .header3-user-menu-wrap {
        position: relative;
    }

    .header3-user-menu-wrap .hover-user-top-menu {
        top: 100%;
        left: auto;
        right: 0;
        padding-top: 10px;
...
<div class="top-navbar z-1035 h-35px h-sm-auto top-bar top-background-color-visibility"
                    ...
                    @if (get_setting('show_language_switcher') == 'on')
                        <li class="list-inline-item dropdown mr-4 lang-visibility" id="lang-change">
                            ...
                            <a href="javascript:void(0)" class="dropdown-toggle fs-12 py-2 top-text-color-visibility"
                                data-toggle="dropdown" style="color: {{ $topHeaderTextColor }}" data-display="static">
    ...
    <div class="position-relative logo-bar-area border-md-nonea z-1025">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <button type="button" class="btn d-lg-none mr-3 mr-sm-4 p-0 active" data-toggle="class-toggle"
                    ...
                    <svg id="Component_43_1" data-name="Component 43 – 1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <rect id="Rectangle_19062" data-name="Rectangle 19062" width="16" height="2"
                            transform="translate(0 7)" fill="#ffffff" />
                        <rect id="Rectangle_19063" data-name="Rectangle 19063" width="16" height="2"
                            fill="#ffffff" />
                        <rect id="Rectangle_19064" data-name="Rectangle 19064" width="16" height="2"
                            transform="translate(0 14)" fill="#ffffff" />
                    </svg>
                ...
                <div class="d-none d-xl-block ml-auto mr-0 header3-user-menu-wrap">
                    @auth
                        <span
                    ...
                    @else
                        ...
                        <span class="d-flex align-items-center nav-user-info ml-3">
                            ...
                            <a href="{{ route(get_setting('customer_registration_verify') === '1' ? 'registration.verification' : 'user.registration') }}"
                                style="color: {{ $middleHeaderTextColor }}" {{-- <a href="{{ route('user.registration') }}" --}}
