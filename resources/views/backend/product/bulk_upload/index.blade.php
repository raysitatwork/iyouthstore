    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="alert"
                ...
                <p>4.
                    {{ translate('After uploading products you need to edit them and set product\'s images and choices') }}.
                </p>
            </div>
            <br>
            <div class="">
        ...
        <div class="card-body">
            <form class="form-horizontal" action="{{ route('bulk_product_upload') }}" method="POST"
                ...
                <div class="alert mb-3"
                    style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    <h6 class="mb-2">
                        <strong>⚠️ {{ translate('Important: Before Product Import') }}</strong>
                    </h6>
                    <p class="mb-2">
                        {{ translate('For updating existing products, first export your products using Bulk Export.') }}
                    </p>

                    <ul class="mb-0">
                        <li>
                            <strong>{{ translate('Existing Product Update:') }}</strong>
                            {{ translate('Exported file में मौजूद Product ID को same रखें और product की जानकारी जैसे name, price, stock, category, brand आदि change करके import करें. Product update हो जाएगा.') }}
                        </li>

                        <li>
                            <strong>{{ translate('New Product:') }}</strong>
                            {{ translate('अगर किसी नई product row में Product ID blank है, तो वह एक नया product create करेगा.') }}
                        </li>

                        <li>
                            <strong>{{ translate('Product ID:') }}</strong>
                            {{ translate('Existing product को update करने के लिए उसका सही Product ID होना जरूरी है.') }}
                        </li>

                        <li>
                            <strong>{{ translate('Images & Choices:') }}</strong>
                            {{ translate('Import के बाद product को edit करके images और choices जरूर check/set करें.') }}
                        </li>
                    </ul>
