        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['add_new_product', 'show_all_products', 'show_in_house_products', 'show_seller_products',
                    ...
                    'view_all_brands', 'brand_bulk_upload', 'view_product_attributes', 'view_colors',
                    'view_product_warranties', 'view_product_reviews'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                                    ...
                                                    ->where(function ($query) {
                                                        $query
                                                            ...
                                                            ->orWhere(function ($subQuery) {
                                                                ...
                                                                $subQuery
                                                                    ->whereHas('preorder_product', function (
                                                                        $innerQuery,
                                                                    ) {
                                            ...
                                            @can('view_all_delayed_prepayment_preorders')
                                                <li class="aiz-side-nav-item">
                                                    <a href="{{ route('delayed_prepayment_preorders.list') }}"
                                                        class="aiz-side-nav-link">
                                                        <span class="aiz-side-nav-text">{{ translate('Delayed Prepayment') }}
                                                            <span
                                            ...
                                            @can('view_all_final_preorders')
                                                <li class="aiz-side-nav-item">
                                                    <a href="{{ route('delayed_final_orders.list') }}" class="aiz-side-nav-link">
                                                        <span class="aiz-side-nav-text">{{ translate('Delayed Final Orders') }}
                                                            <span
                ...
                @if (addon_is_activated('refund_request'))
                    @canany(['view_refund_requests', 'view_approved_refund_requests', 'view_rejected_refund_requests',
                        'refund_request_configuration', 'set_category_wise_refund'])
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <div class="aiz-side-nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                @if (get_setting('vendor_system_activation') == 1)
                    @canany(['view_all_seller', 'seller_payment_history', 'view_seller_payout_requests',
                        ...
                        'seller_verification_form_configuration', 'set_category_wise_commission',
                        'set_seller_based_commission'])
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <div class="aiz-side-nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                    ...
                                    <li class="aiz-side-nav-item">
                                        @php
                                            $sellers = \App\Models\Shop::where('verification_status', 0)
                                                ...
                                                ->count();
                                        @endphp
                                        <a href="{{ route('sellers.index') }}" class="aiz-side-nav-link">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{ route('out_of_stock') }}">
                                        <span
                                            class="aiz-side-nav-text">{{ translate('Seller Out Of Stock Request') }}</span>
                                    </a>
                                </li>
                                ...
                                @can('view_pending_seller')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('sellers.registration_pending') }}" class="aiz-side-nav-link">
                                ...
                                @can('view_profile_update_request')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('admin.profile.update.requests') }}" class="aiz-side-nav-link">
                ...
                <!-- marketing -->
                @canany(['view_all_flash_deals', 'view_all_dynamic_popups', 'view_all_custom_alerts',
                    'manage_email_templates', 'send_newsletter', 'notification_settings', 'view_all_notification_types',
                    'send_custom_notification', 'view_custom_notification_history', 'send_bulk_sms', 'view_all_subscribers',
                    'view_all_coupons'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                ...
                @canany(['payment_methods_configurations', 'african_pg_configuration',
                    'african_pg_credentials_configuration', 'view_all_manual_payment_methods',
                    'view_all_offline_payment_orders', 'view_all_offline_wallet_recharges',
                ...
                <!--                @endcan --}}-->
                            ...
                            @endcanany
                            @canany(['shipping_configuration', 'select_shipping_methods', 'shipping_country_setting',
                                'manage_shipping_states', 'manage_shipping_cities', 'manage_zones', 'manage_carriers'])
                                <li class="aiz-side-nav-item">
                                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                                        ...
                                        @can('manage_shipping_cities')
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('subdistricts.index') }}"
                                                    ...
                                                    <span
                                                        class="aiz-side-nav-text">{{ translate('Shipping Sub Districts') }}</span>
                                                </a>
                                            </li>
                                        @endcan
